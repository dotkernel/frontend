...
class Message
{
    ...
    const USER_ALREADY_DEACTIVATED = 'This account is already deactivated.';
    const USER_ACTIVATED_SUCCESSFULLY = 'Successfully activated.';
    const USER_DEACTIVATED_SUCCESSFULLY = 'Successfully deactivated.';
    const PASSWORD_RESET_SUCCESSFULLY = 'Password Successfully reset.';
